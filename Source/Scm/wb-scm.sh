...
SCMPYTHONPATH=${BUILDER_TOP_DIR}/Source/Scm:${BUILDER_TOP_DIR}/Source/Git:${BUILDER_TOP_DIR}/Source/Hg:${BUILDER_TOP_DIR}/Source/Common

if [ "$PYTHONPATH" = "" ]
then
	export PYTHONPATH=${SCMPYTHONPATH}
else
	export PYTHONPATH=${SCMPYTHONPATH}:$PYTHONPATH
fi
